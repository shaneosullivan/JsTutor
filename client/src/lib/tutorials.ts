...
export function getTutorialHelp(tutorial: Tutorial) {
  return TUTORIAL_DESCRIPTIONS[tutorial.order as keyof typeof TUTORIAL_DESCRIPTIONS] || {
    tips: ["Try the example code first", "Read the instructions carefully", "Don't be afraid to experiment!"],
