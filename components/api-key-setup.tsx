        ...
        <CardContent className="flex-1 flex flex-col justify-center p-6">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg space-y-3 text-left">
                <p className="text-gray-700">
                  <strong>Hey there, future programmer!</strong> To get your AI
                  helper working, you'll need a special "API key" from OpenAI.
                </p>

                <p className="text-gray-700">
                  <strong>
                    You might need to ask your parent or guardian to help with
                    this part!
                  </strong>{" "}
                ...
                <div className="bg-yellow-50 p-3 rounded border-l-4 border-yellow-400">
                  <p className="text-sm text-gray-700">
                    <strong>Don't worry!</strong> Your key stays safe on your
                    computer and is never shared with anyone else.
                  </p>
                </div>
              </div>
            ...
            <div className="flex gap-3 justify-center">
              ...
              >
                <Key className="w-4 h-4 mr-2" />I Have My API Key!
              </Button>
