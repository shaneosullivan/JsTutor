...
export const ShortHairBrown: React.FC<ProfileIconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 64 64" className={className}>
    ...
    {/* Hair */}
    <path
      d="M22 20 Q32 14 42 20 Q40 24 32 24 Q24 24 22 20"
      fill={HAIR_COLORS.brown}
    />
    <path
      d="M22 20 Q26 18 32 18 Q38 18 42 20 Q40 22 32 22 Q24 22 22 20"
      fill={HAIR_COLORS.brown}
    />
    {/* Eyes */}
...
export const MediumHairBrown: React.FC<ProfileIconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 64 64" className={className}>
    ...
    {/* Hair */}
    <path
      d="M20 20 Q32 12 44 20 Q42 26 32 26 Q22 26 20 20"
      fill={HAIR_COLORS.brown}
    />
    <path
      d="M20 22 Q24 20 32 20 Q40 20 44 22 Q42 24 32 24 Q22 24 20 22"
      fill={HAIR_COLORS.brown}
    />
    {/* Hair sides */}
...
export const LongHairBrown: React.FC<ProfileIconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 64 64" className={className}>
    ...
    {/* Hair top */}
    <path
      d="M18 18 Q32 10 46 18 Q44 28 32 28 Q20 28 18 18"
      fill={HAIR_COLORS.brown}
    />
    <path
      d="M18 20 Q26 18 32 18 Q38 18 46 20 Q44 26 32 26 Q20 26 18 20"
      fill={HAIR_COLORS.brown}
    />
    {/* Eyes */}
    <circle cx="28" cy="26" r="1.5" fill="#374151" />
...
export const SpikyHairBrown: React.FC<ProfileIconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 64 64" className={className}>
    ...
    {/* Spiky hair base */}
    <path
      d="M22 22 Q32 16 42 22 Q40 26 32 26 Q24 26 22 22"
      fill={HAIR_COLORS.brown}
    />
    {/* Spikes */}
